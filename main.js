      ...
      //FOR RAIN      
        ...
        || conditions == "Light Rain"){
          ...
          $(".conditions").append('<img class="sunclouds" id="suncloud01" src="'+baseurl+'/weather/suncloud_01.svg" alt="Cloud01"></img>'+
              '<img class="sunclouds" id="suncloud02" src="'+baseurl+'/weather/suncloud_02.svg" alt="Cloud02"></img>'+
              '<img class="sunclouds" id="suncloud03" src="'+baseurl+'/weather/suncloud_03.svg" alt="Cloud03"></img>'+
              '<img class="fog" id="fog" src="'+baseurl+'/weather/fog_main.svg" alt="Fog"></img>'+
              '<img class="sunclouds" id="suncloud03" src="'+baseurl+'/weather/fogcloud_01.svg" alt="Fog01"></img>'+
              '<img class="sunclouds" id="suncloud01" src="'+baseurl+'/weather/fogcloud_02.svg" alt="Fog02"></img>'+
              '<img class="sunclouds" id="suncloud02" src="'+baseurl+'/weather/fogcloud_03.svg" alt="Fog03"></img>');
          $(".objects").append('<img class="sunclouds" id="suncloud01" src="'+baseurl+'/weather/fogface_01.svg" alt="Cloud01"></img>'+
              '<img class="sunclouds" id="suncloud02" src="'+baseurl+'/weather/fogface_02.svg" alt="Cloud02"></img>'+
              '<img class="sunclouds" id="suncloud03" src="'+baseurl+'/weather/fogface_03.svg" alt="Cloud03"></img>');
